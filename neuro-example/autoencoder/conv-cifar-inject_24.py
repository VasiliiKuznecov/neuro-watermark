...
plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector24.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector24.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection24.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection24.png', show_shapes=True)

epoch_number = 2 * 60
batches_number = 1000
batch_size = 50

f1=open('neuro-example/autoencoder/cifar-24/stats.txt', 'w+')
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-24/cifar_injector24-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-24/cifar_deinjector24-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-24/cifar_injection24-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-24/cifar_not_injection24-' + str(e) + '.h5')
