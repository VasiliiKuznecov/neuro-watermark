...
injector = load_model('neuro-example/autoencoder/injector4.h5')
deinjector = load_model('neuro-example/autoencoder/deinjector4.h5')
injection = load_model('neuro-example/autoencoder/injection4.h5')
not_injection = load_model('neuro-example/autoencoder/not_injection4.h5')
