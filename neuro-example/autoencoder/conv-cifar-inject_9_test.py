...
injector = load_model('neuro-example/autoencoder/cifar-9/cifar_injector9-0.h5')
deinjector = load_model('neuro-example/autoencoder/cifar-9/cifar_deinjector9-0.h5')
injection = load_model('neuro-example/autoencoder/cifar-9/cifar_injection9-0.h5')
not_injection = load_model('neuro-example/autoencoder/cifar-9/cifar_not_injection9-0.h5')
