...
injector = load_model('neuro-example/autoencoder/injector3.h5')
deinjector = load_model('neuro-example/autoencoder/deinjector3.h5')
injection = load_model('neuro-example/autoencoder/injection3.h5')
# not_injection = load_model('neuro-example/autoencoder/not_injection3.h5')
