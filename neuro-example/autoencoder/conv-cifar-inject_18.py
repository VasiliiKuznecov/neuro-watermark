...
injection.compile(optimizer=keras.optimizers.Adam(lr=0.00005), loss=[sum_squared_error, 'categorical_crossentropy'], loss_weights=[1, 1])
not_injection.compile(optimizer=keras.optimizers.Adam(lr=0.00005), loss='categorical_crossentropy', loss_weights=[1])

injection.summary()
not_injection.summary()


plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector18.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector18.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection18.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection18.png', show_shapes=True)

epoch_number = 60
batches_number = 1000
batch_size = 50

f1=open('neuro-example/autoencoder/cifar-18/stats.txt', 'w+')
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-18/cifar_injector18-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-18/cifar_deinjector18-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-18/cifar_injection18-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-18/cifar_not_injection18-' + str(e) + '.h5')
