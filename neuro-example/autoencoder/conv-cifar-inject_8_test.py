...
injector = load_model('neuro-example/autoencoder/cifar-8/cifar_injector8-0.h5')
deinjector = load_model('neuro-example/autoencoder/cifar-8/cifar_deinjector8-0.h5')
injection = load_model('neuro-example/autoencoder/cifar-8/cifar_injection8-0.h5')
not_injection = load_model('neuro-example/autoencoder/cifar-8/cifar_not_injection8-0.h5')
