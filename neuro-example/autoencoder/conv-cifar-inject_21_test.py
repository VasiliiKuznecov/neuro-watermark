...
injection = load_model('neuro-example/autoencoder/cifar-21/cifar_injection21-179.h5')
not_injection = load_model('neuro-example/autoencoder/cifar-21/cifar_not_injection21-179.h5')
