...
injection.compile(optimizer='adam', loss=[sum_squared_error, 'binary_crossentropy'], loss_weights=[1, 0.375])
not_injection.compile(optimizer='adam', loss='binary_crossentropy', loss_weights=[0.375])

injection.summary()
not_injection.summary()


plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector8.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector8.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection8.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection8.png', show_shapes=True)
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-8/cifar_injector8-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-8/cifar_deinjector8-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-8/cifar_injection8-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-8/cifar_not_injection8-' + str(e) + '.h5')
