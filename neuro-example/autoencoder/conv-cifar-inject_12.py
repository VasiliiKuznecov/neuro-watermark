...
injection.compile(optimizer='adam', loss='binary_crossentropy', loss_weights=[1.2, 0.5])
not_injection.compile(optimizer='adam', loss='binary_crossentropy', loss_weights=[0.5])

injection.summary()
not_injection.summary()


plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector12.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector12.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection12.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection12.png', show_shapes=True)

epoch_number = 60
batches_number = 1000
batch_size = 50

f1=open('neuro-example/autoencoder/cifar-12/stats.txt', 'w+')
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-12/cifar_injector12-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-12/cifar_deinjector12-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-12/cifar_injection12-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-12/cifar_not_injection12-' + str(e) + '.h5')
