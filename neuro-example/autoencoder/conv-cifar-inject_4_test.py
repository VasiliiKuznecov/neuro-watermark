...
injector = load_model('neuro-example/autoencoder/cifar-4/cifar_injector4-0.h5')
deinjector = load_model('neuro-example/autoencoder/cifar-4/cifar_deinjector4-0.h5')
injection = load_model('neuro-example/autoencoder/cifar-4/cifar_injection4-0.h5')
not_injection = load_model('neuro-example/autoencoder/cifar-4/cifar_not_injection4-0.h5')
