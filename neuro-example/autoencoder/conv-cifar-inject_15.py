...
injection.compile(optimizer=keras.optimizers.Adam(lr=0.0001), loss=[sum_squared_error, 'categorical_crossentropy'], loss_weights=[0.7, 1])
not_injection.compile(optimizer=keras.optimizers.Adam(lr=0.0001), loss='categorical_crossentropy', loss_weights=[1])

injection.summary()
not_injection.summary()


plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector15.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector15.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection15.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection15.png', show_shapes=True)

epoch_number = 60
batches_number = 1000
batch_size = 50

f1=open('neuro-example/autoencoder/cifar-15/stats.txt', 'w+')
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-15/cifar_injector15-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-15/cifar_deinjector15-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-15/cifar_injection15-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-15/cifar_not_injection15-' + str(e) + '.h5')
