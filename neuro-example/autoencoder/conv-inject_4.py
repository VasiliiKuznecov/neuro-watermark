...
plot_model(injector, to_file='imgs/models/autoencoder/injector4.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/not_injector4.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/injection4.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/not_injection4.png', show_shapes=True)
...
injector.save('neuro-example/autoencoder/injector4.h5')
deinjector.save('neuro-example/autoencoder/deinjector4.h5')
injection.save('neuro-example/autoencoder/injection4.h5')
not_injection.save('neuro-example/autoencoder/not_injection4.h5')
