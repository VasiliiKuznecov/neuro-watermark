...
def create_deep_conv_ae():
    ...
    x = Conv2DTranspose(16, (3, 3), activation='sigmoid', padding='same')(x)
...
plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector23.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector23.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection23.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection23.png', show_shapes=True)

epoch_number = 4 * 60
batches_number = 1000
batch_size = 50

f1=open('neuro-example/autoencoder/cifar-23/stats.txt', 'w+')
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-23/cifar_injector23-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-23/cifar_deinjector23-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-23/cifar_injection23-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-23/cifar_not_injection23-' + str(e) + '.h5')
