...
plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector26.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector26.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection26.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection26.png', show_shapes=True)

epoch_number = 4 * 60
batches_number = 1000
batch_size = 50

f1=open('neuro-example/autoencoder/cifar-26/stats.txt', 'w+')
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-26/cifar_injector26-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-26/cifar_deinjector26-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-26/cifar_injection26-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-26/cifar_not_injection26-' + str(e) + '.h5')
