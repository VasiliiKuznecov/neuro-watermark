...
injection.compile(optimizer='adam', loss=[sum_squared_error, 'binary_crossentropy'], loss_weights=[1, 0.25])
not_injection.compile(optimizer='adam', loss='binary_crossentropy', loss_weights=[0.25])

injection.summary()
not_injection.summary()


plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector7.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector7.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection7.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection7.png', show_shapes=True)
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-7/cifar_injector7-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-7/cifar_deinjector7-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-7/cifar_injection7-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-7/cifar_not_injection7-' + str(e) + '.h5')
