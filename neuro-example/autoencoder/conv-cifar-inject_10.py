...
injection.compile(optimizer='adam', loss=[sum_squared_error, 'binary_crossentropy'], loss_weights=[1, 0.4375])
not_injection.compile(optimizer='adam', loss='binary_crossentropy', loss_weights=[0.45])

injection.summary()
not_injection.summary()


plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector10.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector10.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection10.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection10.png', show_shapes=True)
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-10/cifar_injector10-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-10/cifar_deinjector10-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-10/cifar_injection10-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-10/cifar_not_injection10-' + str(e) + '.h5')
