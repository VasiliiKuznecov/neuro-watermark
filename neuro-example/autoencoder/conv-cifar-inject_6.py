...
injection.compile(optimizer='adam', loss=[sum_squared_error, 'binary_crossentropy'], loss_weights=[1, 0.5])
...
plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector6.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector6.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection6.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection6.png', show_shapes=True)
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-5/cifar_injector6-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-5/cifar_deinjector6-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-5/cifar_injection6-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-5/cifar_not_injection6-' + str(e) + '.h5')
