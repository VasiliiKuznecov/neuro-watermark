...
autoencoder = load_model('neuro-example/autoencoder/cifar-mac-1/autoencoder.h5')
...
f1=open('neuro-example/autoencoder/cifar-mac-3/stats.txt', 'w+')
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-mac-3/cifar_injector3-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-mac-3/cifar_deinjector3-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-mac-3/cifar_injection3-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-mac-3/cifar_not_injection3-' + str(e) + '.h5')
