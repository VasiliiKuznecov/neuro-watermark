...
not_injection.compile(optimizer='adam', loss='binary_crossentropy', loss_weights=[0.4375])

injection.summary()
not_injection.summary()


plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector9.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector9.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection9.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection9.png', show_shapes=True)
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-9/cifar_injector9-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-9/cifar_deinjector9-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-9/cifar_injection9-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-9/cifar_not_injection9-' + str(e) + '.h5')
