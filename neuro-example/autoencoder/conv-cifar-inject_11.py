...
injection.compile(optimizer='adam', loss=[sum_squared_error, 'binary_crossentropy'], loss_weights=[1.1, 0.5])
...
plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector11.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector11.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection11.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection11.png', show_shapes=True)
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-11/cifar_injector11.1-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-11/cifar_deinjector11.1-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-11/cifar_injection11.1-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-11/cifar_not_injection11.1-' + str(e) + '.h5')
