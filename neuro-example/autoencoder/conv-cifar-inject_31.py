...
injection.compile(optimizer=keras.optimizers.Adam(lr=0.000001), loss=[sum_squared_error, 'categorical_crossentropy'], loss_weights=[1.2, 0.7])
...
f1=open('neuro-example/autoencoder/cifar-31/stats.txt', 'a', 1)
