...
plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector14.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector14.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection14.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection14.png', show_shapes=True)

epoch_number = 60
batches_number = 1000
batch_size = 50

f1=open('neuro-example/autoencoder/cifar-14/stats.txt', 'w+')
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-14/cifar_injector14-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-14/cifar_deinjector14-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-14/cifar_injection14-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-14/cifar_not_injection14-' + str(e) + '.h5')
