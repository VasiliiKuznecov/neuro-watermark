...
injector = load_model('neuro-example/autoencoder/cifar-7/cifar_injector7-0.h5')
deinjector = load_model('neuro-example/autoencoder/cifar-7/cifar_deinjector7-0.h5')
injection = load_model('neuro-example/autoencoder/cifar-7/cifar_injection7-0.h5')
not_injection = load_model('neuro-example/autoencoder/cifar-7/cifar_not_injection7-0.h5')
