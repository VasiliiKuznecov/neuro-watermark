...
plot_model(injector, to_file='imgs/models/autoencoder/cifar_injector5.png', show_shapes=True)
plot_model(deinjector, to_file='imgs/models/autoencoder/cifar_not_injector5.png', show_shapes=True)
plot_model(injection, to_file='imgs/models/autoencoder/cifar_injection5.png', show_shapes=True)
plot_model(not_injection, to_file='imgs/models/autoencoder/cifar_not_injection5.png', show_shapes=True)
...
for e in range(epoch_number):
    ...
    injector.save('neuro-example/autoencoder/cifar-5/cifar_injector5-' + str(e) + '.h5')
    deinjector.save('neuro-example/autoencoder/cifar-5/cifar_deinjector5-' + str(e) + '.h5')
    injection.save('neuro-example/autoencoder/cifar-5/cifar_injection5-' + str(e) + '.h5')
    not_injection.save('neuro-example/autoencoder/cifar-5/cifar_not_injection5-' + str(e) + '.h5')
